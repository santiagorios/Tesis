...
jQuery(function($) {
  ...
  window.FileUploadEvents = function() {
    this.fileuploadFunction = $.proxy(this.fileuploadFunction, this);
  };

  FileUploadEvents.prototype = {
    fileuploadFunction: function(e) {
  ...
  window.fileUploadEvents = new FileUploadEvents();
  $('form a.add_nested_fields').live('click', fileUploadEvents.fileuploadFunction);
  $(document).ready(function() {
    fileUploadEvents.fileuploadFunction();
  });
});
